...
public class TableView2 extends ViewGroup {
     ...
     * @return
     */
    public TableView2 setWidthTableCount(int widthTable) {
     ...
     * @return
     */
    public TableView2 setHeightTableCount(int heightTable) {
     ...
     * @return
     */
    public TableView2 setFilterTable(boolean isFilterTable) {
